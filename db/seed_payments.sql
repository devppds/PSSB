...
('pembayaran-tahunan-baru', 'Uang Gedung Santri Baru', '45.000', 1),
('pembayaran-tahunan-baru', 'Uang Pangkal Santri Baru', '25.000', 2),
('pembayaran-tahunan-baru', 'Buku Tata Tertib', '3.000', 3),
('pembayaran-tahunan-baru', 'Administrasi', '5.000', 4),
('pembayaran-tahunan-baru', 'Pendidikan', '5.000', 5),
('pembayaran-tahunan-baru', 'Jam’iyyah Pusat', '16.000', 6),
('pembayaran-tahunan-baru', 'Jam’iyyah Fariyah', '17.000', 7),
('pembayaran-tahunan-baru', 'Kalender', '25.000', 8),
('pembayaran-tahunan-baru', 'Buku 3 Tokoh', '16.000', 9),
('pembayaran-tahunan-baru', 'LBM', '16.500', 10),
('pembayaran-tahunan-baru', 'Kas Keuangan', '1.500', 11),
('pembayaran-tahunan-baru', 'Haul Haflah', '15.000', 12),
('pembayaran-tahunan-baru', 'Ta’dhim Maulid', '15.000', 13);
...
('pembayaran-tahunan-lama', 'Jam’iyyah Fariyah', '17.000', 5),
...
('pembayaran-ketentuan', 'Pembayaran dana pembangunan, maklumat, dan pembelian tanah dihitung per KK.', 3),
('pembayaran-ketentuan', 'Iuran pembayaran di atas belum termasuk pembayaran MHM, MIU, Iuran Daerah, dan kas kamar.', 4);

-- Settings for Summary
INSERT OR REPLACE INTO site_settings (key, value) VALUES ('estimasi_baru', '383.500');
